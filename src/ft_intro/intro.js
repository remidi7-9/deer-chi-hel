...
const MoveTonextcomponent = () => {
  ...
  return (
    <div>
          ...
          {showSun && <div className='zoom-in-background'><img src={image1}/></div>}
...
const Intro = () => {
  const [bgNum, setBgNum] = useState(1); // State to manage the current background image number
  ...
  return (
    <>
    <div className='Index'>
       <div id="bg" style={{ backgroundImage: `url(${getBackgroundImageUrl(bgNum)})` }}></div>
        {/* <div className="Marvel"><p className='introh1'>School Of Athens</p></div> */}
        <div className="Article">
          <div className='content'>

          <Typewriter  text={`Did you ever imagine that the greatest PHILOSOPHERS\n\n natural scientists\n\n mathematicians\n\n astronomers\n\n In history would gather under one roof?\n\n Exchanging ideas\n\n It's a beautiful idea, but impossible?\n\n Raphaello Sanzio did it!\n\n`} delay={40} />
      <br/>
...
const getBackgroundImageUrl = (bgNum) => {
  switch (bgNum) {
    case 1:
      return image1;
    case 2:
